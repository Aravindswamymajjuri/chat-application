...
const MessageActions = ({
  ...
  return (
    <div className="message-actions" onClick={(e) => e.stopPropagation()}>
      <button className="action-btn reply-btn" onClick={handleReply} disabled={loading}>
      ...
      <button className="action-btn delete-for-me-btn" onClick={handleDeleteForMe} disabled={loading}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {isOwnMessage && (
        <button className="action-btn delete-all-btn" onClick={handleDelete} disabled={loading}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="3 6 5 6 21 6"/>
            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
